    ...
    return (<>
        ...
        <Animated.View style={styles.container}>
            <View style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: screenWidth, gap: 10, position: mosaics && mosaics.length>0 ? "relative" : "absolute", top: 0}}>
              ...
              <HoldItem key={"Test"} items={AddItems} closeOnTap hapticFeedback="Heavy" activateOn="tap" menuAnchorPosition="bottom-right" containerStyles={{position: 'absolute', bottom: 15, right:15,zIndex: 10}}>
                  <RoundButton title="+"/>
              </HoldItem>
              )}
        </Animated.View>
