...
const steps = [
    { title: 'What’s a mozaï', paragraph: 'For you to be able to take full advantage of the application, however, we need access to your photos. This is because the application uses your own images to personalize your experience and provide you with the best possible functionality.', video: require('../assets/videos/OnBoarding/video1.mp4')},
    { title: 'Photo privacy', paragraph: 'Your privacy is very important to us. Your photos are completely private and will never be shared or stored on our servers. They are only used within the application to provide you with a personalized experience.', video: require('../assets/videos/OnBoarding/video2.mp4')},
    { title: 'Photo sharing', paragraph: 'This application lets you share your photos with friends and family in a private and secure circle. You retain total control over what you choose to share, and we ensure that your experience remains personal and intimate.', video: require('../assets/videos/OnBoarding/video3.mp4')}
];
